// AVENTUREIRO TEMA 3 IF ELSE ELSE IF SUPER TRUNFO
//Aluno Diego Felipe Gimenez de Andrade
//matrC-cula 202507372408
//2026.1
//Objetivo:
//o jogador possa escolher o atributo de comparação entre duas cartas de países.
...
int main() {
	...
	fflush(stdout);//força a limpeza (flush) do buffer de saída
...
superpoder1 = ( (float)populacao1+ (float)area1+ (float)pib1+ (float)pontosTuristicos1+ (float)PIBpercapta1+ (float)(1.0/DensidadePop1));
 ...
 int option;
    ...
    do {
        printf("Menu de seleção de critério de avaliação:\n");
        printf("1. população\n");
        printf("2. área\n");
        printf("3. PIB\n"); 
        printf("4. pontosTuristico\n"); 
        ...
        switch(option) {
            case 1:
                ...
                break;
            case 2:
                printf("Você escolheu a opção 2 área\n");
                printf("%s: %lf\n", cidade1, area1);
                printf("%s: %lf\n", cidade2, area2);
                	if (area1 > area2)
            ...
            case 3:
                ...
                break;
             case 4:
                printf("Você escolheu a opção 4 Pontos Turísticos\n");
             ...
             case 5:
                ...
                break;
             case 6:
                printf("Você escolheu a opção 6 PIB percapta\n");
